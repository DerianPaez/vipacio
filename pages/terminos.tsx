  ...
  return (
    <TermsStyled>
      <Section className="terms">
        ...
        <ul>
          <li>
            <p><strong>Afiliado</strong> significa una entidad que controla, es controlada o está bajo control común con una parte, donde &ldquo;control&ldquo; significa la propiedad del 50% o más de las acciones, participación accionaria u otros valores con derecho a voto para la elección de directores u otra autoridad administrativa.</p>
          </li>
          <li>
            <p><strong>País</strong> se refiere a: Ecuador</p>
          </li>
          <li>
            <p><strong>Compañia</strong> (referida como &ldquo;la Empresa&ldquo;, &ldquo;Nosotros&ldquo;, &ldquo;Nos&ldquo; o &ldquo;Nuestro&ldquo; en este Acuerdo) se refiere a Vipacio</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Los Términos y condiciones</strong> (también denominados &ldquo;Términos&ldquo;) significan estos Términos y condiciones que forman el acuerdo completo entre Usted y la Compañía con respecto al uso del Servicio.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>El sitio web</strong> se refiere a Vipacio, accesible desde <a href="https://www.vipacio.com" rel="external nofollow noopener noreferrer" target="_blank">https://www.vipacio.com</a></p>
          </li>
          <li>
        ...
        <p>Sin perjuicio de los daños en los que pueda incurrir, la responsabilidad total de la Compañía y cualquiera de sus proveedores en virtud de cualquier disposición de estos Términos y Su recurso exclusivo por todo lo anterior se limitará al monto que realmente pagó a través del Servicio o 100 USD. si no ha comprado nada a través del Servicio.</p>
        ...
        <p>Usted declara y garantiza que (i) no se encuentra en un país sujeto al embargo del gobierno de los Estados Unidos, o que ha sido designado por el gobierno de los Estados Unidos como un país de &ldquo;apoyo al terrorismo&ldquo;, y (ii) no está incluido en cualquier lista del gobierno de los Estados Unidos de partes prohibidas o restringidas.</p>
        ...
        <h3>Exención</h3>
        <p>Salvo lo dispuesto en el presente, la falta de ejercicio de un derecho o de exigir el cumplimiento de una obligación en virtud de estos Términos no afectará la capacidad de una parte para ejercer dicho derecho o exigir dicho cumplimiento en cualquier momento posterior ni la renuncia a un incumplimiento constituirá una renuncia a cualquier incumplimiento posterior.</p>
        ...
        <ul>
          <li>Por correo electrónico: contacto@vipacio.com</li>
        </ul>
      </Section>
    </TermsStyled>
  )
