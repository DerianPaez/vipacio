    ...
    <PrivacyStyled>
      <Section className="privacy">
        ...
        <ul>
          ...
          <li>
            <Paragraph><strong>Compañía</strong> (denominado &ldquo;la Compañía&ldquo;, &ldquo;Nosotros&ldquo;, &ldquo;Nos&ldquo; o &ldquo;Nuestro&ldquo; en este Acuerdo) se refiere a Vipacio</Paragraph>
          </li>
          <li>
          ...
          <li>
            <Paragraph><strong>Sitio web</strong> se refiere a Vipacio, accesible desde <a href="https://www.vipacio.com" rel="external nofollow noopener noreferrer" target="_blank">https://www.vipacio.com</a></Paragraph>
          </li>
          <li>
        ...
        <Paragraph>Las cookies pueden ser cookies &ldquo;persistentes&ldquo; o de &ldquo;sesión&ldquo;. Las cookies persistentes permanecen en su computadora personal o dispositivo móvil cuando se desconecta, mientras que las cookies de sesión se eliminan tan pronto como cierra su navegador web. Más información sobre las cookies: <a href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank" rel="noreferrer">Cookies: ¿Qué hacen ?</a>.</Paragraph>
        ...
        <Paragraph>Le informaremos por correo electrónico y / o un aviso destacado en Nuestro Servicio, antes de que el cambio entre en vigencia y actualizaremos la fecha de &ldquo;Última actualización&ldquo; en la parte superior de esta Política de privacidad.</Paragraph>
